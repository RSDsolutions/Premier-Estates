        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="modal-body">
            ...
            <label className="field">
              ...
              <input className="input" type="number" placeholder="285000" {...register('price', { required: 'Requerido', min: 1 })} />
              {errors.price && <small style={{ color: 'var(--err)' }}>{errors.price.message}</small>}
            </label>
            <label className="field">
              <span>Año de construcción</span>
              <input className="input" type="number" placeholder="2022" {...register('year')} />
            </label>
